  ...
  return (
    <header className="fixed z-50 w-full transition-all">
      <nav className="ml-auto mr-auto flex h-14 items-center justify-between border-b border-b-gray-300 bg-gray-800 px-3 py-3 lg:w-[70%] ">
        ...
        <button
          className="h-8 w-8 font-bold md:hidden"
      ...
      ></div>
      <aside
        className={`fixed z-50 ml-auto h-screen w-64 max-w-[calc(100%-3rem)] flex flex-col justify-between bg-gray-700 opacity-100 duration-300 ${
